...
public class WstChatCtrl {
     ...
     */
    @GetMapping("/wst/chat")
    PageInfo<WstChatMo> list(final WstChatMo mo, @RequestParam(value = "pageNum", required = false) Integer pageNum, @RequestParam(value = "pageSize", required = false) Integer pageSize) {
